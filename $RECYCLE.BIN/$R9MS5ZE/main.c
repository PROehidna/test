...
{																															/*  																																																																												    */
	...
	GPIOA->PUPDR &= ~GPIO_PUPDR_PUPDR9;													/* Отключение подтягивающих резисторов для линии PA.9.  (сброс обоих битов для линии 9 в регистре GPIOA_PUPDR)                                                                                                    */
	...
	GPIOA->PUPDR &= ~GPIO_PUPDR_PUPDR10;												/* Сброс режима подтягивающих резисторов для линии PA.9. (оба подтягивающих резистора отключаются)                                                                                                       */
