...
{																																										/*  																																																																												    */
	...
	USART1->BRR = 416;																																/* Настройка делителя частоты тактирующего USART и задающего скорость приема и передачи данных на уровне 115200 бит/с: Частота тактирующего генератора = 8 МГц;	*/
																																										/* Скорость обмена по USART = 19200 бит/с; коэффициент деления = 8000000 / 19200 = 416                                																				  */
